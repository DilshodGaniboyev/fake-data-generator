package com.srp.runner;

import com.srp.domains.Field;
import com.srp.domains.FileType;
import com.srp.fakerService.FakerApplicationService;
import com.srp.domains.FakerApplicationGenerateRequest;
import com.srp.domains.FieldType;
import com.srp.fileService.WorkWithFiles;

import java.util.*;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static com.srp.fakerService.FakerApplicationService.BLACK_LIST;
...
public class FakerApplicationRunner {
    ...
    private static FileType getValidFileType() {
        ...
        return WorkWithFiles.findByName(scanner.nextLine());
    }
